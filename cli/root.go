// Package cli assembles the geocodingmeteo command tree from the geocodingmeteo
...
// NewApp assembles the kit application from the geocodingmeteo domain. The
...
//
// To add a command, declare it in geocodingmeteo/domain.go with kit.Handle and it
// appears here automatically. Reach for app.AddCommand only for a verb that does
// not fit the emit-records shape, the way version does below.
func NewApp() *kit.App {
	id := geocodingmeteo.Domain{}.Info().Identity
	id.Version = Version

	app := kit.New(id)
	(geocodingmeteo.Domain{}).Register(app)
