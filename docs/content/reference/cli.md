...
```
geocodingmeteo <command> [arguments] [flags]
```

Run `geocodingmeteo <command> --help` for the full flag list on any command. This
...
per operation you declare in `geocodingmeteo/domain.go`.
