...
// HTTP behaviour is covered in geocodingmeteo_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "geocodingmeteo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("geocodingmeteo", "about")
	if err != nil || got.String() != "geocodingmeteo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want geocodingmeteo://page/about", got.String(), err)
	}
}
